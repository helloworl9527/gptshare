...
export const api = {
  ...
  logout: () => request('/api/auth/logout', { method: 'POST' }),
	...
	banMonitorAccount: (id) => request(`/api/accounts/${encodeURIComponent(id)}/ban`, { method: 'POST', body: {} }),
	retryMonitorAccountSync: (id) => request(`/api/accounts/${encodeURIComponent(id)}/sync-allocation`, { method: 'POST', body: {} }),
