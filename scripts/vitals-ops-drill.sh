...
sqlite3 "$tmp/db/monitor.db" "CREATE TABLE schema_migrations(version INTEGER); INSERT INTO schema_migrations VALUES(5); CREATE TABLE marker(value TEXT); INSERT INTO marker VALUES('monitor');"
